<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="A3GoodGums.index" %>
    ...
    <form id="indexForm" runat="server">
        <div style="margin-bottom: 20px;">
            <h1>Customer Purchases</h1>
                <asp:GridView ID="gvPurchase" runat="server" CssClass="gridview" AutoGenerateColumns="false">   
                  <Columns>
                    <asp:BoundField DataField="id" HeaderText="ID" ItemStyle-HorizontalAlign="Center"/>
                    <asp:BoundField DataField="fullName" HeaderText="Full Name" />
                    <asp:BoundField DataField="emailAddress" HeaderText="Email Address" />
                    <asp:BoundField DataField="productname" HeaderText="Product Name" />
                    <asp:BoundField DataField="unitprice" HeaderText="Unit Price" ItemStyle-HorizontalAlign="Center"/>
